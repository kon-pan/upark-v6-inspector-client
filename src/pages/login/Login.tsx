...
const Login = () => {
  ...
  return (
    <div className='flex h-screen flex-col items-center bg-blue-700'>
      {/* Logo */}
      <div className='py-12 text-3xl font-medium text-gray-50'>
      ...
      <form
        ...
        className={classNames(
          'flex w-10/12 flex-col rounded border border-neutral-100 bg-white text-neutral-800 shadow-md shadow-neutral-100'
        )}
      >
